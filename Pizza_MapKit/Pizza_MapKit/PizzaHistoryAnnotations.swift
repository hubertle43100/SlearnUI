...
class PizzaHistoryAnnotations{
    ...
    init(){
        ...
        annotation.pizzzaPhoto = #imageLiteral(resourceName: "Naples")
        ...
        annotation.pizzzaPhoto = #imageLiteral(resourceName: "New York")
        ...
        annotation.pizzzaPhoto = #imageLiteral(resourceName: "Chicago")
        ...
        annotation.pizzzaPhoto = #imageLiteral(resourceName: "Chatham")
        ...
        annotation.pizzzaPhoto = #imageLiteral(resourceName: "Beverly Hills")
